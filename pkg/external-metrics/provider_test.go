...
func makeProvider(t *testing.T, promClient external_metrics.PromClient) (client.Client, provider.ExternalMetricsProvider) {
	...
	metricsProvider := external_metrics.NewMetricsProvider(k8sClient, promClient, klogr.New())

	return k8sClient, metricsProvider
}

func makeMetric(metricName string, promQuery string) v1alpha1.PrometheusMetric {
	metric := v1alpha1.PrometheusMetric{
		...
		Spec: v1alpha1.PrometheusMetricSpec{
